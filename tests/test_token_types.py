...
def test_custom_token_type_claim_validation(client: TestClient, Authorize: AuthJWT) -> None:
...
def test_custom_token_type_names_validation(client: TestClient, Authorize: AuthJWT) -> None:
    class TestConfig(BaseSettings):
        authjwt_secret_key: str = "secret"
